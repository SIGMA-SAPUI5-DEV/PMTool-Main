sap.ui.define([
	...
	return Controller.extend("ZNav.controller.V_Dev_Display", {
		...
		fChangeDev: function() {
			...
			oView.byId("inDeveloperId").setValue(iZdeveloper);
			oView.byId("inDeveloperName").setValue(sZdeveloperName);
			oView.byId("inActive").setSelected(sZactive);
           }
		},
		...
		fSaveChangeDev: function() {
			...
			oEntry.Zactive = oView.byId("inActive").getSelected();
