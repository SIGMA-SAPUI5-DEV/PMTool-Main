sap.ui.define([
	...
	return Controller.extend("ZNav.controller.V_Gap", {
		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf ZNav.view.V_Gap
		 */
		onInit: function() {
   ...
   //                 path: "/GapMasterSet",
	...
	// fGoToTarget_1: function() {
		...
		/**
		 *@memberOf ZNav.controller.V_Gap
		 */
		...
		fChangeGap: function() {
			...
			if (!oDialog) {
				...
				oDialog = sap.ui.xmlfragment(oView.getId(), "ZNav.view.GapChange", this);
		...
		fCopyGap: function() {
			...
			if (!oDialog) {
				// create dialog via fragment factory
				oDialog = sap.ui.xmlfragment(oView.getId(), "ZNav.view.GapCopy", this);
				// connect dialog to view (models, lifecycle)
				oView.addDependent(oDialog);
			}
            oDialog.open();
...
/*		fDeleteGap: function() {
			...
			if (!oDialog) {
				// create dialog via fragment factory
				oDialog = sap.ui.xmlfragment(oView.getId(), "ZNav.view.GapDelete", this);
				// connect dialog to view (models, lifecycle)
				oView.addDependent(oDialog);
			}
		...
		fSaveChangeGap: function() {
			...
			// oEntry.Zdomain = oView.byId("inDomain").getValue();
		 	// oEntry.Zdomain1 = oView.byId("inDomain").getSelectedItem();
			var oDomain = this.getView().byId("inDomain").getSelectedItem();
            var oKeyDev = oDomain.getKey();
            oEntry.Zdomain = oKeyDev;
		    ...
		    // var oKey = oEntry.Zdomain1.getKey();
      //      oEntry.Zdomain = oKey;
